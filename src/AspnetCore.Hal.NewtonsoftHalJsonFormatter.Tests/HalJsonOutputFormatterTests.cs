...
using AspnetCore.Hal.NewtonsoftHalJsonFormatter.Models;
...
namespace AspnetCore.Hal.NewtonsoftHalJsonFormatter.Tests
{
    ...
    public class HalJsonOutputFormatterTests
    {
        ...
        public HalJsonOutputFormatterTests()
        {
            ...
            _formatter = new HalJsonOutputFormatter(serializerSettings, charPool, _mvcOptions, _jsonOptions);
        ...
        public async Task WriteResponseBodyAsync_ShouldTransformObjectAndCallBaseMethod()
        {
            ...
            var halResponse = new HalUser { Id = 1, Name = "Test User", Links = new[] { new AspnetCore.Hal.NewtonsoftHalJsonFormatter.Models.Link { Href = "/users/1", Rel = "self" } } };
